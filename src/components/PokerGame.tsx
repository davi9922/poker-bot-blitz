  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="relative">
        ...
        <div className="mx-auto w-[900px] h-[600px] bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 rounded-full border-8 border-amber-900 shadow-2xl relative overflow-hidden">
            ...
            {gameState === 'playing' && !showdown && (
              <div className="absolute top-6 left-6">
                <div className={`px-4 py-2 rounded-full text-sm font-bold shadow-lg ${
                  playerTurn ? 'bg-blue-600 text-white animate-pulse' : 'bg-gray-600 text-white'
                }`}>
        ...
        <div className="mt-8 text-center space-y-4">
          ...
          {gameState === 'playing' && playerTurn && !showdown && (
            <div className="flex flex-wrap justify-center gap-4">
              {canCheck && (
                <Button onClick={handleCheck} variant="outline" className="bg-green-600 text-white border-green-500 hover:bg-green-500 shadow-lg">
                  ✅ Check
                </Button>
              )}
              {canCall && (
                <Button onClick={handleCall} className="bg-blue-600 hover:bg-blue-500 shadow-lg">
          ...
          <div className="flex justify-center gap-4">
            {gameState === 'waiting' && (
              <Button onClick={dealNewHand} size="lg" className="bg-green-600 hover:bg-green-500 shadow-lg">
                🎯 Repartir Cartas
              </Button>
            )}
